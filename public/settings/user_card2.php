...
<div class="container">
    ...
    <div class="header-section">
        <h2>Kullanıcı Yönetim Paneli</h2> <!-- Başlık güncellendi -->
    ...
    <?php if ($filter === 'all' || $filter === 'admin'): ?>
        <?php if (!empty($admins)): ?>
            <div class="list-section">
                <h4>Adminler</h4> <!-- Başlık güncellendi -->
                <?php foreach ($admins as $admin): ?>
                    <div class="user-list-item">
                        <div class="user-details">
                            <strong><?= htmlspecialchars($admin['username']) ?></strong> <!-- Kullanıcı adı eklendi -->
                            <span>Email: <?= htmlspecialchars($admin['email']) ?></span> <!-- Email ayrı satırda -->
                            <span>Rol: <?= htmlspecialchars($admin['role']) ?></span> <!-- Rol ayrı satırda -->
                        </div>
        ...
        <?php if (!empty($kullanicilar)): ?>
            <div class="list-section">
                ...
                <?php foreach ($kullanicilar as $user): ?>
                    <div class="user-list-item">
                        <div class="user-details">
                            <strong><?= htmlspecialchars($user['username']) ?></strong> <!-- Kullanıcı adı eklendi -->
                            <span>Email: <?= htmlspecialchars($user['email']) ?></span> <!-- Email ayrı satırda -->
                            <span>Rol: <?= htmlspecialchars($user['role']) ?></span> <!-- Rol ayrı satırda -->
                        </div>
                        <div class="action-buttons">
