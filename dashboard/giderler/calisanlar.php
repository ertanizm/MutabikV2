        ...
        <div class="sidebar-menu">
            ...
            <div class="menu-section">
                ...
                <div class="submenu" id="sales-submenu">
                    <a href="./teklifler.php" class="submenu-item">
                        <i class="fas fa-file-alt"></i>
                        Teklifler
                    </a>
                    <a href="./faturalar.php" class="submenu-item">
                        <i class="fas fa-file-invoice"></i>
                        Faturalar
                    </a>
                    <a href="../reports/musteriler.php" class="submenu-item active"> <i class="fas fa-users"></i>
                        Müşteriler
                    </a>
