    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu-section">
                ...
                <div class="submenu">
                    <a href="../teklifler/teklifler.php" class="submenu-item active">
        ...
        <div class="top-header">
            ...
            <div class="header-right">
                ...
                <div class="header-actions">
                    <a href="../teklifler/teklifler.php" class="btn-secondary">VAZGEÇ</a>
                    <div class="dropdown">
...
<!-- PROFIL DROPDOWN & WIDGET BİTİŞ -->
    ...
    <script>
        ...
        document.getElementById('saveBtn').addEventListener('click', function() {
            ...
            window.location.href = '../teklifler/teklifler.php';
        });
